...
return array(
	...
	*/
	...
	"digits_between"   => "El campo :attribute debe estar entre :min and :max digitos.",
	"email"            => "EL formato del campo :attribute es invalido.",
	"exists"           => "The selected :attribute is invalid.",
	"image"            => "The :attribute must be an image.",
	"in"               => "The selected :attribute is invalid.",
	"integer"          => "El campo :attribute debe de ser un numero.",
	...
	"min"              => array(
		"numeric" => "El campo :attribute debe de ser de al menos :min.",
